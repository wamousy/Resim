...
export class Connections {
  ...
  render(){
    ...
    if(!link){$('connection-detail').innerHTML=`<p>共 ${visible.length} 条连接；选择一条查看详情。</p>`;return;}
